...
def TrajectoryGenerator(T_se_initial, T_sc_initial, T_sc_final, T_ce_grasp, \
    ...
    np.savetxt("Trajectory.csv", Trajectory, delimiter=",", fmt="%.6f", comments="")
    return Trajectory
...
T_ce_grasp, T_ce_standoff = GraspAndStandoff(135,0.3)
########################## Uncomment the two row to use the test case ######################
...
########################## Uncomment the two row to use the test case ######################
# T_se_initial = T_se(30,0,0,thetalist0)
# T_ce_grasp, T_ce_standoff = GraspAndStandoff(180,0.1)
########################## Uncomment the two row to use the test case ######################
